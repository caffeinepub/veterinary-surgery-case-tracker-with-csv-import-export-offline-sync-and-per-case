...
import { Edit, Calendar, FileText, User, Users, Heart, ClipboardList, Trash2, Cake } from 'lucide-react';
import { nanosecondsToDateOnlyString, formatDateOnlyString, formatDateOfBirth, calculateAge } from '../../utils/dates';
import type { LocalSurgeryCase } from '../../types/cases';
import TasksChecklist from './TasksChecklist';
import SpeciesIndicator from './SpeciesIndicator';
...
export default function CaseCard({ surgeryCase, onEdit }: CaseCardProps) {
  ...
  const age = calculateAge(surgeryCase.patientDemographics.dateOfBirth);
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="space-y-2 flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2">
              <SpeciesIndicator species={surgeryCase.patientDemographics.species} />
            </div>
          </div>

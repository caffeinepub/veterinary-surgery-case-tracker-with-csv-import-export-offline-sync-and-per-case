...
export class Backend implements backendInterface {
    ...
    async getUpdatedCases(arg0: Time): Promise<Array<SurgeryCase>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUpdatedCases(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasUnsyncedChanges(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasUnsyncedChanges();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initUserPrivileges(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initUserPrivileges();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async syncLocalChanges(arg0: Array<SurgeryCase>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.syncLocalChanges(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSurgeryCase(arg0: bigint, arg1: SurgeryCaseUpdate): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSurgeryCase(arg0, to_candid_SurgeryCaseUpdate_n6(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function to_candid_SurgeryCaseUpdate_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SurgeryCaseUpdate): _SurgeryCaseUpdate {
